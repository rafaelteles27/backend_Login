...
* The original package name 'net.guides.springboot.registration-login-demo' is invalid and this project uses 'net.guides.springboot.registrationlogindemo' instead.
